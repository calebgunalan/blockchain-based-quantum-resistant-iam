  ...
  public: {
    Tables: {
      ...
      cross_chain_bridge_proofs: {
        ...
        Relationships: [
          {
            foreignKeyName: "cross_chain_bridge_proofs_primary_did_fkey"
            columns: ["primary_did"]
            isOneToOne: false
            referencedRelation: "cross_chain_identities"
            referencedColumns: ["primary_did"]
          },
        ]
      }
      ...
      cross_chain_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "cross_chain_messages_primary_did_fkey"
            columns: ["primary_did"]
            isOneToOne: false
            referencedRelation: "cross_chain_identities"
            referencedColumns: ["primary_did"]
      ...
      cross_chain_networks: {
        ...
        Relationships: [
          {
            foreignKeyName: "cross_chain_networks_primary_did_fkey"
            columns: ["primary_did"]
            isOneToOne: false
            referencedRelation: "cross_chain_identities"
            referencedColumns: ["primary_did"]
      ...
      user_quantum_settings: {
        Row: {
          classical_kem_private_key_encrypted: string | null
          classical_sig_private_key_encrypted: string | null
          created_at: string
          hybrid_mode_enabled: boolean
          id: string
          kem_private_key_encrypted: string | null
          post_quantum_enabled: boolean
          pq_kem_private_key_encrypted: string | null
          pq_sig_private_key_encrypted: string | null
